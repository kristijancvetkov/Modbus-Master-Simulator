...
- Register scanner for FC01, FC02, FC03, and FC04 with optional slave ID range scanning
...
- The scanner checks every configured slave ID from Start Slave ID through Stop Slave ID and scans the configured register count from Start Address.
